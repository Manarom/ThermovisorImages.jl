...
md"""
	...
	$(@bind add_file PlutoUI.FilePicker())
	"""

# ╔═╡ 0340be3f-bae5-455b-bd91-88312b006477
add_file
...
begin 
	...
	if !isnothing(add_file)
		add_file_name = add_file["name"]
		save(add_file_name,add_file["data"])
		selected_file_full_name = joinpath(images_folder,add_file_name)
		push!(files_in_dir, add_file_name=> add_file_temperature=>selected_file_full_name)
	end
	
	files_in_dir_tags = keys(files_in_dir)
end

# ╔═╡ c70110ba-eff8-4b03-bb7e-93965159c8ef
save(add_file_name,add_file["data"])

# ╔═╡ 3eb1fa9c-fd18-4131-adc4-7c63baba1f79
add_file_name
...
# ╔═╡ e81e552d-5e1b-43b2-84c2-d86300f1fc0f
tt=read_temperature_file(files_in_dir[temp_to_load][2])

# ╔═╡ 412a5445-4fbc-4f8b-b432-057cdd2911e3
files_in_dir[temp_to_load]

# ╔═╡ dcb38a1c-b8b8-427d-b253-32891469ac0a
Is(FileType.Image, files_in_dir[temp_to_load][2])

# ╔═╡ 57779063-451c-4afc-a4cb-41ae78469fd6
files_in_dir[temp_to_load][2]
...
begin # generating pattern 
	fit_multiple
	Patterns_number = 50 #total number of patterns
	image_size = (640,640)
...
manifest_format = "2.0"
project_hash = "e96eeaa1e3fe20993913f067960ced1a66293731"
